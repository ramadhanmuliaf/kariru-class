...
<head>
    ...
    <title>Kariru Class | Edit Ruang</title>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        ...
                        <form action="<?php echo site_url('crudbarang/updatebarangDb'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                          <input type="hidden" name="id" value="<?php echo $detail->id_barang; ?>" />
                          ...
                          <div class="row form-group"> <!--dibuat dropdown-->
                            <div class="col col-md-3">
                               <label class="form-control-label" for="kb">Status Ruangan</label>
                            </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="file" id="gb" name="gb" value="<?php echo $detail->gambar; ?>" class="form-control" required></div>
                          </div>
                          
                          <div class="row form-group">
                               <div class="col col-md-3"><label for="db" class=" form-control-label">Deskripsi</label></div>
                               <div class="col-12 col-md-9"><input type="text" id="db" name="db" value="<?php echo $detail->deskripsi; ?>" class="form-control" required></div>
                          </div>
