...
<head>
    ...
    <title>Kariru Class | Laporan Peminjaman</title>
        ...
        <header id="header" class="header">
            ...
            <div class="header-menu">
                ...
                <div class="col-sm-7">
                    ...
                    <h3>Laporan Peminjaman Admin</h3>
                    </div>
				</div>
			</div>
        </header><!-- /header -->
                ...
                <div class="col-md-12">
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <td>
                            <a class="btn btn-success btn-sm" style="color: white;" href="<?php echo site_url('laporanbarang/cetak/'.$br->id_pb);?>"class="btn btn-small" target="_blank"><i class="fa fa-print" ></i>Cetak</a>
