                 ...
                 <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <td>
                            <a class="btn btn-primary btn-sm" href="<?php echo site_url('crudbarang/edit/'.$br->id_barang);?>"class="btn btn-small"><i class="fa fa-edit"></i>Edit</a>
                            <a class="btn btn-danger btn-sm"  data-toggle="modal" data-target="#staticModal<?php echo $br->id_barang; ?>" style="color: white;" onclick="confirm_modal('<?php echo site_url('crudbarang/hapus/'.$br->id_barang);?>','Title');" class="btn btn-small"><i class="fa fa-trash-o"></i>Hapus</a>
						</td>
						</tr>
