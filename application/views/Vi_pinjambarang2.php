...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url('assets/images/key.png')?>">
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand"><img src="<?php echo base_url('assets/images/borrowit.png');?>" alt="Logo"></a>
                <a class="navbar-brand hidden"><img src="<?php echo base_url('assets/images/key.png');?>" alt="Logo"></a>
            </div>
